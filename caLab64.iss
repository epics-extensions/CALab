...
AppId={{94C1F593-8FB8-5A57-B0FC-B9E37495FEFE}
...
LicenseFile="LICENSE"
OutputBaseFilename=caLabSetup_1803x64
OutputDir=.
...
VersionInfoOriginalFileName=caLabSetup_1803x64.exe
...
Filename: {tmp}\vc_redist.x64.exe; Parameters: "/passive /norestart"; StatusMsg: Installing VC++ RunTime ...
