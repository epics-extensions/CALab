...
Source: "Release\calab.dll"; DestDir: "{app}\lib"; Components: caLab
Source: "src\*.cpp"; DestDir: "{app}\src"; Components: sources
Source: "src\*.h"; DestDir: "{app}\src"; Components: sources

// EPICS Dependencies
Source: "..\..\..\epics\current-epics-base\bin\win32-x86\*.dll"; DestDir: "{app}\lib"; Components: caLab or caTools
Source: "..\..\..\epics\current-epics-base\bin\win32-x86\*.exe"; DestDir: "{app}\lib"; Components: caLab or caTools
